...
import com.tripbd.driver.view.MainActivity;
...
public class RunningTripAdapter extends RecyclerView.Adapter<RunningTripAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
       ...
       // holder.tv_loading_upazila_district.setText(context.getString(R.string.area)+": "+trip.getLoadingUpazilaThana());
        //holder.tv_loading_full_address.setText(context.getString(R.string.full_address)+": "+trip.getLoadingFullAddress() +"\n"+context.getString(R.string.nearby_school_mosque_others)+": "+trip.getLoadingLandmark());
        //holder.tv_unloading_upazila_district.setText(context.getString(R.string.area)+": "+trip.getUnloadingUpazilaThana());
      //  holder.tv_unloading_full_address.setText(context.getString(R.string.full_address)+": "+trip.getUnloadingFullAddress() +"\n"+context.getString(R.string.nearby_school_mosque_others)+": "+trip.getUnloadingLandmark());
        ...
        if((!trip.getStopPointPersonName().isEmpty())&&trip.getStopPointPersonName().length()>3){
            holder.tv_stopPointPersonNameMobileAddress.setText(
                    context.getString(R.string.address)+trip.getStopAddress()+"\n"+
                    context.getString(R.string.personname)+trip.getStopPointPersonName()+"\n"+
                    context.getString(R.string.phone_number)+trip.getStopPointPersonPhoneNumber()
            );

        }
        holder.tv_trip_price.setText(trip.getRentalPrice()+context.getString(R.string.tk));
        ...
        holder.tv_loading_full_address.setText(
                context.getString(R.string.area)
                        ...
                        +": "+trip.getCustomer().getPhoneNumber()
        ...
        Toast.makeText(context, "Trip Vehicle type: "+trip.getVehicle().getType(), Toast.LENGTH_SHORT).show();
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView tv_car_details,tv_loading_date_time,tv_loading_upazila_district,
                ...
                tv_stopPointPersonNameMobileAddress, tv_description_header;
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            tv_stopPointPersonNameMobileAddress =  findViewById(R.id.tv_stopPointPersonNameMobileAddress);
            ...
            btn_complete_trip.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    builder.setTitle(context.getString(R.string.haveyoucompletedtrip));
