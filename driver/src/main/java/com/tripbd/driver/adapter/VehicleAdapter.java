    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if (vehicle!=null){
            if (vehicle.getType().equalsIgnoreCase("Truck")||
                ...
                holder.txtv_vehicle_year.setText(context.getString(R.string.model_year)+": "+vehicle.getYear());
                ...
                Toast.makeText(context, context.getString(R.string.seat)+vehicle.getSeat(), Toast.LENGTH_SHORT).show();
