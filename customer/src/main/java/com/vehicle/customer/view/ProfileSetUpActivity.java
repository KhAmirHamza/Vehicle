...
public class ProfileSetUpActivity extends AppCompatActivity {
    ...
    private void addCustomer(Customer customer) {
        ...
        db.collection("customer").add(customer).addOnSuccessListener(documentReference -> {
            Log.d(TAG, "DocumentSnapshot written with ID: " + documentReference.getId());
            SharedPreferences sharedPreferences = getSharedPreferences("AUTHENTICATION", Context.MODE_PRIVATE);
            sharedPreferences.edit().putString("CUSTOMER_PHONE_NUMBER", phone_number).apply();
            sharedPreferences.edit().putString("CUSTOMER_EMAIL", email).apply();
            sharedPreferences.edit().putString("CUSTOMER_NAME", name).apply();
