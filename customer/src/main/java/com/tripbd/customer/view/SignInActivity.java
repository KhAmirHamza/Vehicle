                ...
                for (QueryDocumentSnapshot doc : Objects.<QuerySnapshot>requireNonNull(value)) {
                    ...
                    if (customer.getName() != null) {
                        ...
                        if (customer.getPhoneNumber().equalsIgnoreCase(phoneNumber) &&
                            ...
                            sharedPreferences.edit().putString("USER_EMAIL", customer.getEmail()).apply();
                            sharedPreferences.edit().putString("USER_NAME", customer.getName()).apply();
                            sharedPreferences.edit().putString("USER_IMAGE_URL", customer.getImageUrl()).apply();
                            sharedPreferences.edit().putString("USER_ID", customer.getId()).apply();
                            sharedPreferences.edit().putString("USER_PASSWORD", password).apply();
                            sharedPreferences.edit().putString("USER_ADDRESS", customer.getAddress()).apply();
                            startActivity(new Intent(SignInActivity.this, MainActivity.class));
                            finish();
                        } else {
