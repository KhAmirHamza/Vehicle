...
public class ProfileFragment extends Fragment {
    ...
    TextView txtv_name, txtv_email,txtv_phone_number, tvHelpline;
                                    ...
                                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                        ...
                                        ref.getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                                            ...
                                            public void onComplete(@NonNull Task<Uri> task) {
                                                ...
                                                db.collection("user").document(UserModel.getId()).update(driverProfileImageMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    @Override
            ...
            db.collection("user").document(id).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                ...
                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                    ...
                    if (UserModel ==null){
                        ...
                        //todo...
                        Picasso.get().load(UserModel.getImageUrl()).into(imgv_profile_image);
                        txtv_name.setText(UserModel.getName());
                        txtv_email.setText(UserModel.getEmail());
                        txtv_phone_number.setText(UserModel.getPhoneNumber());
                    }
                }
            }).addOnFailureListener(new OnFailureListener() {
                @Override
