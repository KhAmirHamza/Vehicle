...
import static com.tripbd.user.Constants.CUSTOMER_SUPPORT_NUMBER;
...
import com.tripbd.user.Constants;
import com.tripbd.user.R;
import com.tripbd.user.adapter.BidAdapter;
...
public class TripFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnUpdateTrip.setSelected(true);
    ...
    void setViews(){
        ...
        if (driver!=null){
            ...
            txtv_driver_phone_number.setText(getString(R.string.toCallDriver, driver.getPhoneNumber()));
